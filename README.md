...
- [Day 3: Character Counter](./vue-projects/day-03-character-counter)


## 🎯 Progress

- [x] Day 1: Setup & Template Syntax (CDN)
- [x] Day 2: v-bind & Data Binding (CDN)
- [ ] Day 3: Reactive Data (Vue CLI) ← Currently here